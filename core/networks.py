from keras.layers import (Activation, Conv2D, Dense, Dropout,
                          ...
                          MaxPooling2D, UpSampling2D, concatenate, multiply)
from keras.models import Model
from .config import IMG_SHAPE, IMG_SHAPE_4
...
def gan_model(generator, discriminator):
    inputs = Input(shape=IMG_SHAPE_4)
...
def unet_spp_large_swish_generator_model():
    ...
    conv5 = concatenate(
        [
            ...
            MaxPooling2D(pool_size=(5, 5), strides=1, padding="same")(conv5),
        ],
        axis=3,
    )
